...
export const MobileVerseGuide = React.memo(({ chapterNum, verseNum, koreanText }: MobileVerseGuideProps) => {
    ...
    return (
        <section className="block w-full overflow-hidden rounded-[1.5rem] border border-gold-border/20 bg-shell-main p-4 shadow-[0_12px_24px_-16px_rgba(0,0,0,0.12)] dark:border-dark-border/45 dark:bg-shell-main-dark lg:hidden">
            <div className="flex items-center gap-2.5 border-b border-gold-border/12 pb-2 dark:border-dark-border/30">
                <span className="inline-flex items-center rounded-full bg-gold-primary/10 px-2.5 py-0.5 text-[9px] font-semibold uppercase tracking-[0.24em] text-gold-primary dark:bg-gold-light/10 dark:text-gold-light">
                    Verse Guide
                </span>
