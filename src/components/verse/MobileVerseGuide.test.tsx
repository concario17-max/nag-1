...
describe('MobileVerseGuide', () => {
    // 장, 절 정보와 한글/영문 텍스트가 정상 렌더링되는지 검증함
    it('장, 절 정보와 번역 텍스트를 정상적으로 렌더링함', () => {
        render(
            <MobileVerseGuide
                chapterNum="1"
                verseNum="1"
                englishText="Now, the exposition of Yoga."
        ...
        // 영어 텍스트 확인
        expect(screen.getByText('Now, the exposition of Yoga.')).toBeInTheDocument();
